...
export function DecisionCard({ decision, onDelete, index }: DecisionCardProps) {
  return (
    <div key={decision.id} className={cn(
      ...
      <div className="flex justify-between items-start">
        ...
        <Button variant="ghost" size="icon" className="absolute top-3 right-3 opacity-0 group-hover:opacity-100 transition-opacity rounded-lg" onClick={() => onDelete(decision.id)}>
